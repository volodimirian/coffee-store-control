...
- [ ] настроить translation file для английского языка & удалить ненужные ключи по активации не активации и т.д.
- [ ] при не активных секциях (категориях) не отображаются категории (подкатегории)
