...
[x] должна быть кнопочка копировать ИНН
[x] для каждого поставщика должна быть своя дата отсрочки
[x] поставщики название, инн, ндс, отсрочка
[x] сделать месячный вью со списком поставщиков и счетов
[x] помечать просроченную оплату счетов
[x] дата создания, дата оплаты, поставщик, номер счета, сумма, статус и действия (порадок колонок)
[x] отступы побольше в таблице между столбцами и группами
[x] сдлеать поиск по категориям в создании счета
[x] счета вынести в одльный меню оплаты
главная страница
[x] категории убрать
[x] дней до конца месяца убрать
[x] расходы в месяц только оплаченные счета
